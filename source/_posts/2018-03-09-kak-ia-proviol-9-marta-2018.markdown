...
И потом мы пошли в "Пятерочку", которая там рядом.

В Останкино на пятачке сосредоточены "Пятерочка", "Дикси" и "Магнит" + еще этот "Мартин", а чуть дальше есть "Матрица".
